                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (confirmDialogResponse) {
                                            await viewNoteNotesRecord.reference
                                                .delete();
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      if (viewNoteNotesRecord.wasUpdated ==
                                          false)
                                        Text(
                                          'Created ${dateTimeFormat(
                                            "relative",
                                            viewNoteNotesRecord.creationDate,
                                      ...
                                      if (viewNoteNotesRecord.wasUpdated ==
                                        ...
                                        Text(
                                          'Updated ${dateTimeFormat(
                                            "relative",
                                            viewNoteNotesRecord.updatedDate,
                                            locale: FFLocalizations.of(context)
                                                .languageCode,
                                          )}',
                                          style: FlutterFlowTheme.of(context)
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            viewNoteNotesRecord.noteContent,
                                            maxLines: 5,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
