...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.textController9 ??=
        TextEditingController(text: currentUserDocument?.socialMedia.facebook);
    _model.textFieldFocusNode9 ??= FocusNode();

    _model.textController10 ??=
        TextEditingController(text: currentUserDocument?.socialMedia.linkedIn);
    _model.textFieldFocusNode10 ??= FocusNode();

    _model.textController11 ??=
        TextEditingController(text: currentUserDocument?.socialMedia.youTube);
    ...
    _model.textController13 ??=
        TextEditingController(text: currentUserDocument?.socialMedia.tikTok);
                              ...
                              onPressed: () async {
                                await currentUserReference!.update({
                                  ...createUsersRecordData(
                                    ...
                                    job: _model.textController2.text,
                                    bio: _model.textController6.text,
                                    ...
                                    socialMedia: createSocialMediaStruct(
                                      ...
                                      linkedIn: _model.textController10.text,
                                      youTube: _model.textController11.text,
                                      twitter: _model.textController12.text,
                                  ...
                                  ...mapToFirestore(
                                    {
                                      'rewardPoints': FieldValue.increment(100),
                                    },
                                  ),
                                });
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text:
                                                'Paste the full URL in the socail text field',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Inter',
