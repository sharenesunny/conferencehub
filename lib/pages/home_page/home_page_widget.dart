                        ...
                        builder: (context, snapshot) {
                          ...
                          return Column(
                            ...
                            children: List.generate(
                                columnNoticeRecordList.length, (columnIndex) {
                              final columnNoticeRecord =
                                  columnNoticeRecordList[columnIndex];
                              return Visibility(
                                visible: FFAppState().dismissNotice.contains(
                                        columnNoticeRecord.noticeId) !=
                                    true,
                                child: Container(
                                  width:
                              ...
                              filterFn: (columnIndex) {
                                final columnNoticeRecord =
                                    columnNoticeRecordList[columnIndex];
                                return FFAppState().dismissNotice.contains(
                                        columnNoticeRecord.noticeId) !=
                                    true;
                              },
                            ),
