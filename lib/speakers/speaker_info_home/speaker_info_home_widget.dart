...
import 'speaker_info_home_model.dart';
export 'speaker_info_home_model.dart';

class SpeakerInfoHomeWidget extends StatefulWidget {
  const SpeakerInfoHomeWidget({
    super.key,
    this.homeSpeaker,
    this.speakersInner,
  });

  final DocumentReference? homeSpeaker;
  final DocumentReference? speakersInner;

  @override
  State<SpeakerInfoHomeWidget> createState() => _SpeakerInfoHomeWidgetState();
}

class _SpeakerInfoHomeWidgetState extends State<SpeakerInfoHomeWidget> {
  late SpeakerInfoHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SpeakerInfoHomeModel());
          ...
          child: Align(
            ...
            child: Container(
              ...
              child: StreamBuilder<SpeakerRecord>(
                stream: SpeakerRecord.getDocument(widget.homeSpeaker!),
